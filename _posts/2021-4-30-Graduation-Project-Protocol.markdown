...
After learning ad hoc networks, OSPF and RIP protocol running in router, MQTT and HTTP protocol in application layer, I was very interested in network protocols, while at that time, I was working on my graduation project. Therefore, I decided to design my own protocol, as an additional part of the graduation project. <!-- outline-start -->This protocol I named it LAN Communication protocol, and it use to make function call between devise, and I realize this protocol by Python.<!-- outline-end --> (To be honest, I should realize it by C or C++ because of the efficiency, but I was quite busy at that time. So I had to use Python)
